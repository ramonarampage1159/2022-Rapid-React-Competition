...
Record Path.vi
	I added code so that it will create a path file, the first time it saves date, afterwards it will just append
	The little i outside the case structure is called "First Call?", it only executes once
